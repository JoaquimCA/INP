...
model Room5X "Indoor air virtual volume with 2D particle dispersion and one source"
  ...
  ParticleConductor particleConductorD(Q = Qd) annotation(
    Placement(visible = true, transformation(origin = {0, 62}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Components.ParticleConductor particleConductorE(Q = Qe) annotation(
...
equation
  ...
  connect(particleConductorC.port_b, port_c) annotation(
    Line(points = {{-18, -68}, {-18, -81}, {-60, -81}, {-60, -100}}, color = {191, 0, 0}));
  connect(particleConductorC.port_a, particleCapacitor.port) annotation(
    Line(points = {{-18, -48}, {-18, -23}, {-42, -23}, {-42, 26}}, color = {191, 0, 0}));
  ...
  connect(port_e, particleConductorE.port_b) annotation(
    Line(points = {{62, -98}, {24, -98}, {24, -68}}, color = {85, 170, 255}));
  connect(particleConductorE.port_a, particleConductorB.port_a) annotation(
    Line(points = {{24, -48}, {24, 0}, {40, 0}}, color = {191, 0, 0}));
  connect(port_x, particleConductorC.port_a) annotation(
    Line(points = {{-100, -100}, {-82, -100}, {-82, -48}, {-18, -48}}, color = {191, 0, 0}));
  annotation(
